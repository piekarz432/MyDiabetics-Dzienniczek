...
public class NoteDetails extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        content = view.findViewById(R.id.noteDetailsContent);
        edit = view.findViewById(R.id.progressBarEditNote);

        content.setMovementMethod(new ScrollingMovementMethod());
        content.setText(applicationStorage.getNoteViewHolder().getNoteContent());

        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_noteDetails_to_updateNote);
